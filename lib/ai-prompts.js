...
## REGLAS CRÍTICAS DE PERSONALIZACIÓN (OBLIGATORIAS)

La narrativa DEBE:
1. Usar el NOMBRE del usuario en las primeras 2 frases
2. Citar AL MENOS 2 logros CONCRETOS con números EXACTOS del CV (ej: "cuando escalaste de 0 a 180 clientes...", "cuando conseguiste un ROAS de 2.1x...")
3. Identificar el SUPERPODER como la intersección ÚNICA de 2-3 skills que esta persona tiene y otros no
4. Incluir "Lo que otros ven en ti" — basado en lo que dijeron en el assessment
5. El "aha_moment" debe ser algo que el usuario NO sabía de sí mismo pero que tú detectaste
6. Tono: mentor cercano que ha leído el CV con ATENCIÓN, no terapeuta corporativo

NUNCA escribir frases genéricas como:
- "Tienes un gran potencial"
- "Eres un profesional completo"
- "Tu perfil es interesante"
- "Tienes habilidades valiosas"

Cada frase debe estar anclada en DATOS CONCRETOS del CV.

## OUTPUT (JSON estricto)
{
  "narrative_text": "[Narrativa completa con los 6 párrafos - PERSONALIZADA con nombre y datos concretos]",
  ...
  "aha_moment": "Probablemente no sabías que tu combinación de [skill1] + [skill2] te coloca en el top 5% de candidatos para roles de [rol] — la mayoría tiene una o la otra, casi nadie tiene ambas.",
  "momentum_sentence": "Ahora mismo, con tu perfil, el mercado está buscando exactamente a alguien como tú para [oportunidad específica detectada].",
  "top_strengths": [
    {
...
Para CADA rol, la narrativa DEBE:
1. Usar el NOMBRE del usuario en why_you_fit_specific
2. Citar logros ESPECÍFICOS del CV que aplican a ESTE rol concreto
3. El "surprise_factor" debe revelar algo que el usuario NO habría considerado
4. El "now_moment" debe incluir un DATO de mercado 2026 verificable
5. El "quick_win_7_days" debe ser una ACCIÓN concreta ejecutable en 7 días

NUNCA escribir frases genéricas como:
- "Tu perfil encaja bien"
- "Tienes potencial para este rol"
- "Tu experiencia es relevante"
...
## OUTPUT (JSON estricto)
{
  ...
  "why_you_fit_specific": "[NOMBRE], tus [X años/experiencia específica] gestionando [contexto concreto del CV] son EXACTAMENTE el background que buscan para este rol — ya conoces [sector/skill específica relevante].",
  "surprise_factor": "Probablemente no lo habías considerado, pero tu historial de [logro específico del CV] te diferencia del 90% de candidatos — la mayoría viene de [background típico], no tiene tu [ventaja única].",
  "now_moment": "En 2026, la demanda de [rol] con background [característica del usuario] en [país] creció [X]% — tu momento es ahora.",
  "quick_win_7_days": "Esta semana: [acción concreta 1] y [acción concreta 2] usando tu [skill/logro del CV] como gancho.",
  ...
  "gaps": [
    {
      ...
      "time_weeks": 3,
      "priority": "alta",
      "resource_url": "https://www.gainsight.com/academy/"
    }
  ],
  "strengths": [
    {
  ...
  "linkedin_message_template": "Hola [Nombre], soy [Usuario] y después de [X años/experiencia] en [sector/rol anterior] me estoy orientando hacia [rol target]. Vi que trabajas en [empresa]. ¿Tendrías 15 min para una llamada sobre el día a día del rol y qué buscan en candidatos?",
  "total_gap_weeks": 3,
