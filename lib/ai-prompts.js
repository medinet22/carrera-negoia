...
- Comience nombrando al usuario
- Resuma su perfil de forma cálida pero profesional
- Destaque 3-4 fortalezas únicas con evidencias específicas
- Mencione cómo estas habilidades se complementan
- Termine con una frase motivacional sobre su potencial
- NUNCA uses clichés vacíos ("persona proactiva", "gran profesional")
- SÍ usa datos concretos del CV ("tus 8 años en finanzas...")
...
1. **ATS-friendly:** Usa keywords del rol target naturalmente
...
4. **Relevancia:** Ordena bullets por relevancia para el rol target
5. **Longitud:** Máximo 2 páginas, idealmente 1 para <10 años de experiencia
